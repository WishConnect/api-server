...
| `V20260819_10__always_open_reviewed_at.sql` | 상시모집 장학금의 관리자 마지막 원문 확인 시각 추가 | ⬜ 미적용 |
| `V20260819_11__create_admin_job_run.sql` | 관리자 배치 실행 이력·부분 실패 알림 테이블 추가 | ⬜ 미적용 |
| `V20260819_12__admin_audit_snapshots.sql` | 수기 수정·내리기 변경 전후 스냅샷과 1회 복구 이력 추가 | ⬜ 미적용 |
